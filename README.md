...
> 1) Было непонятно, откуда взять айдишник аккаунта. Я решила, что нам нужно работать только с существующими аккаунтами, а несуществующие айдишники не обрабатывать и кидать ошибку. 
