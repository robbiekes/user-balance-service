...
> 1) Было непонятно, откуда взять айдишник аккаунта. Я решила, что нам нужно работать только с существующими аккаунтами, а несуществующие айдишники не обрабатывать и кидать ошибку. 2) Не поняла, как методы начисления и списания объединить в один, поэтому сделала две разных операции. 3) По тз не обязательны были файлы миграции, но я их добавила, потому что мне с ними удобнее и привычнее
